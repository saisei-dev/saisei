 ...
 * tests/test_runtime_abi_contract.py. */
 ...
 * the per-binary wrapper generated by ir_to_c.py's PCSwitchRenderer. */
typedef struct {
  bool pending;
  uint32_t addr;
  uint16_t expected;
...
/* shim_log_crash: always writes (ignores RUN_SILENT) and lands on stdout
