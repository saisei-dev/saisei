...
pub fn emit_chunk_known(
    ...
    let mut out: Vec<String> = vec![
        ...
        "// to hand-instrument, edit and recompile the .so (the .sha stays valid).".to_string(),
        "#![no_std]".to_string(),
        ...
        // prelude's `site()` passes it as the `file` arg to every *_impl call.
        format!("pub const SAISEI_SITE: &core::ffi::CStr = c\"{binary_name}\";"),
        String::new(),
    ];
    out.extend(dispatch);
    out.push(String::new());
